function FMRI_EmotionsOutlierId_Vis_SPM12(subjectdir)
...
%-----------------------------------------------------------------------
matlabbatch{end+1}.spm.tools.art.sess.motionfiletype.SPM.mvmtfile = cellstr(fullfile(subjectdir,'spm','RawEPI','rp_epi_0002.txt'));
