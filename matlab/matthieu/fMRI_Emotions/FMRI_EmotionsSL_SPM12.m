function FMRI_EmotionsSL_SPM12(inputdir,Grp,subjectsGrp,NumContrast,ContrastName)
...
matlabbatch{end}.stats{1}.factorial_design.masking.em = cellstr(fullfile(inputdir,'mean_SL_mask.nii'));
