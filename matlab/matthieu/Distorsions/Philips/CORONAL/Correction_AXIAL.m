function [dX,dZ,dR,Xv,Zv,Ima1info,y0]= Correction_AXIAL(name,Pf,Xf,Cgt)
...
title('Représentation des isocontours de déformation radiale dans le plan sagittal','FontSize',14);
