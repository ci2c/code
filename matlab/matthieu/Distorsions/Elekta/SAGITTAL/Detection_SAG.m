function Cg = Detection_SAG(name,sequence,threshold,maxDef)
...
clf
imshow(Ima1,[],'InitialMagnification','fit');hold on;
title('Add missing detected points : Left click to Add / Right click to Quit','FontSize',20,'FontWeight','bold','Color','r');
plot(Cg(:,1),Cg(:,2),'.g','MarkerSize',12);
...
clf
imshow(Ima1,[],'InitialMagnification','fit');hold on;
title('Delete wrong detected points : Left click to Delete / Right click to Quit','FontSize',20,'FontWeight','bold','Color','r');
plot(Cg(:,1),Cg(:,2),'.g','MarkerSize',12);
ScrSize = get(0,'ScreenSize');
set(gcf,'Units','pixels','Position',ScrSize);
while but == 1
...
figure (14);
imshow(Ima1,[],'InitialMagnification','fit');hold on;
title('Final control points','FontSize',12,'FontWeight','bold');
plot(Cg(:,1),Cg(:,2),'.g','MarkerSize',12);
ScrSize = get(0,'ScreenSize');
set(gcf,'Units','pixels','Position',ScrSize);
hold off