...
%     end
%            
    load defintm;      % Chargement de l'atlas de déformation axial 
    
    xgrille = defintm(4,1).Grille_reguliere_1;
    ygrille = defintm(4,1).Grille_reguliere_2;
    dx = defintm(4,1).Valeurs_deformation_1;
    dy = defintm(4,1).Valeurs_deformation_2;
%     
