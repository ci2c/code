...
% for cp=1:32
    ...
    if (cp < 10)
        name1='/home/matthieu/NAS/matthieu/Distorsions/SCAN/AXIAL/IM-0001-000';
...
%         name1='/home/matthieu/NAS/matthieu/Distorsions/T2_HR_3_MM_501/IM-0005-00';
        ...
        name1='/home/matthieu/NAS/matthieu/Distorsions/SCAN/AXIAL/IM-0001-0';
    end
    name=strcat(name1,int2str(cp),name3);
    
    if exist(name)~=0
        
        [Ivessel,Ima] = Detection_AXIAL(name,cp);   % détection des centres de gravité automatique 
