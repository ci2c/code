...
%Centrage initial des centres de gravit�s
...
% Calcul de la transformation
    ...
    error=er;
    for i=1:size(P0,2)          %Calcul des points recal�s                
        Q(:,i)=R*P0(:,i)+q(5:7);
    end
    Pf=Q';                     
...
% Calcul des centres de gravit�s de l'ensemble des points mesur�s et
% th�orique en correspondance
...
% Calcul de l'erreur des moindres carr�s
