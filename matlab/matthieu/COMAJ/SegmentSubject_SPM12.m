function SegmentSubject_SPM12(InputDir, Subject)

% usage : SegmentSubject_SPM12(InputDir, Subject)
%
% Inputs :
%       InputDir            : Input working directory
%       Subject             : Name of the subject
%
%   Segment the subject with SPM12 Segmentation
%
% Matthieu Vanhoutte @ CHRU Lille, Apr. 2016

% close all; clear all;
% 
% InputDir = '/NAS/tupac/matthieu/DARTEL/Controls';

%% Creation of the subject name
SubjectName = cellstr(fullfile(InputDir, [ 'T1.npet.' Subject '.nii,1' ]));
...
matlabbatch{end+1}.spm.spatial.preproc.channel.vols = SubjectName;
