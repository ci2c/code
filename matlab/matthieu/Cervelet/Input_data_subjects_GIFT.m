...
fid = fopen(fullfile(fsdir,'SubjList_GIFT.txt'),'r');
Subj = textscan(fid,'%s');
fclose(fid);
input_data_file_patterns = Subj{1};
...
outputDir = '/NAS/dumbo/protocoles/cervelet-FreeSurf/GIFT/batch_results_default.masks_Preproc1';
...
% maskFile = '/NAS/dumbo/protocoles/cervelet-FreeSurf/GIFT/batch_results_v2/MNI152_T1_2mm_rl_epi_brain_mask.nii';
maskFile = [];
