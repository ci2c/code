...
fit1 <- dcemriS4::dcemri.lm(img, time, mask, model="weinmann", aif="empirical",user=buckley$input)
fit2 <- dcemriS4::dcemri.lm(img, time, mask, model="extended", aif="empirical",user=buckley$input)
