...
function [iField voxel_size matrix_size TE delta_TE CF Affine3D B0_dir TR NumEcho] = Read_Bruker_raw_staticMatrix(fid_dir)
fid_dir
...
matrix_size = [256 150 80] % pour souris car ##$ACQ_size=( 3 ) 400 150 80
%alors que nifti dim = 200*200*80*8, 0.1 mm3
%matrix_size = [256 128 80] % pour objet-test car ##$ACQ_size=( 3 ) 350 128 80
%alors que nifti dim = 170*175*80*8, 
