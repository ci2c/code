function FMRI_TwoSampleTtestBySPM12(outdir,g1Files,g2Files,nameCon,contrast,maskFile)
...
matlabbatch{end}.spm.stats.factorial_design.des.t2.scans1          = g1Files;
matlabbatch{end}.spm.stats.factorial_design.des.t2.scans2          = g2Files;
...
if strcmp(spm('ver'),'SPM12b')
    ...
    matlabbatch{end}.spm.stats.con.consess{1}.tcon.weights = contrast;
...
elseif strcmp(spm('ver'),'SPM8')
    ...
    matlabbatch{3}.spm.stats.con.consess{1}.tcon.convec         = contrast;
