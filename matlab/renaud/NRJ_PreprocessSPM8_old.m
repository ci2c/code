function NRJ_PreprocessSPM8(epi_path,anat_path,TR,nslices,refslice,fwhm,coreg,acquisition,resampling)
...
%--------------------------------------------------------------------------
clear jobs
jobs{1}.util{1}.cdir.directory = cellstr(epi_path);
...
%--------------------------------------------------------------------------
f = spm_select('FPList', epi_path, '^epi_.*\.nii$');
a = spm_select('FPList', anat_path, '^*.nii$');
...
%% RUN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save(fullfile(epi_path,'batch_preprocessing.mat'),'jobs');
spm_jobman('run',jobs);
