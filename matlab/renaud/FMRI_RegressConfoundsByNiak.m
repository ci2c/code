function [files_in,files_out,opt,x,x2]=FMRI_RegressConfoundsByNiak(files_in,files_out,opt)
...
if opt.flag_scrubbing
    ...
    if sum(~mask_scrubbing) < opt.nb_vol_min
     ...
     [p,n,e] = fileparts(files_in.fmri);
     save(fullfile(p,'scrubbing.mat'),'mask_scrubbing');
end
