...
%    nbleft        : number of vertices in left hemisphere
%    templatepath  : templates folder
%    type          : type of selection ('auto' or 'manual');
%
% Option :
%    listCOI       : list of COI (for manual selection) Default: []
%
% Output :
%    resClust      : structure of clustering results
%
