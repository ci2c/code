function ComputeNonParametricTest(matFile)
...
%	$Id: snpm_cp.m,v 8.3 2010/03/15 16:26:17 nichols Exp $	
...
s_SnPM_save = 's_SnPM_save matFile s_SnPMcfg_save S V df1 df MaxT ST_Ut STAT';

%-Check arguments
%-----------------------------------------------------------------------
CWD = spm_str_manip(matFile,'hd');
cur_path=pwd;
if ~strcmp(pwd,CWD)
    cur_path = pwd;
    cd(CWD)
