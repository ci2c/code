function FMRI_PreprocessingBySPM12(structFile,funcFile,steps,opt)
...
%     end
    ...
    matlabbatch{end+1}.spm.tools.art.sess.motionfiletype.SPM.mvmtfile = cellstr(conn_prepend('rp_',funcFile{subj}{1}{1},'.txt'));
    temp = conn_prepend(prefix{1},funcFile{subj});
