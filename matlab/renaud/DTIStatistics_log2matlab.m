function liste_runs = DTIStatistics_log2matlab(filename)
...
%% Sauvegarde de run_courant dans liste_runs
    ...
    xlswrite(xls_filename, {'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc', 'moyenne', 'stdev', 'peak height', 'peak loc','moyenne', 'stdev', 'peak height', 'peak loc','moyenne', 'stdev', 'peak height', 'peak loc'}, nf_run, 'B3');
    
    xlswrite(xls_filename, run_courant.FA, nf_run, 'B4');
    xlswrite(xls_filename, run_courant.L1, nf_run, 'E4');
end
