function sica = FMRI_SicaOneSubject(FileList,maskfile,opt)
...
fprintf('Reading data %s ... - ',FileList(1,:))
V    = spm_vol(FileList);
...
% We only retain the voxels of mask
...
res_ica = st_do_sica(data,optsica);
