...
s4= '_M6/stats/wmparc.stats'; %Pour l'instant le script prend que le M6
...
matwm = []; %matrice finale pour les données de l'hippocampe 
j=0; 
    ...
    if fid ~= -1 %Si il arrive à aller chercher le fichier
        ...
        tline = fgetl(fid);
            ...
            a = strread(tline,'%s','delimiter',' ');
               ...
               if strcmp(a{1},'39') %Même chose pour l'hippocampe droit (ligne 27)
