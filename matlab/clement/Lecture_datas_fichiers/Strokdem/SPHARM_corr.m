...
SurfStatWriteData('/NAS/dumbo/protocoles/MCI/Lille/SPHARM/hpg/disp_norm_tempshparm.txt', Mat_DispNorm);
...
slm=SurfStatLinMod(Mat_DispNorm, M, SurfRef);
contrast=[0,1];
slm = SurfStatT( slm, contrast );


[ pval, peak, clus ] = SurfStatP( slm );
figure; SurfStatView(pval, SurfRef,'SANS COVAR');
