function fig_handle = imagescn(I, scale, dims, FigureWidth, timedimension)


%function fig_handle = my_imagescn(I, scale, dims, FigureWidth, timedimension)
...
fig_handle=get(0,'CurrentFigure');       %Concha
