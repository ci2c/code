...
if isempty(findobj(hToolbar_Children,'Tag', 'figRotateTool')) 
   % The default button size is 15 x 16 x 3. Create Button Image
   button_size_x= 16;
   button_image = NaN* zeros(15,button_size_x);
    
%    f= [...
% 		   4    11    12    13    18    26    27    32    41    43    47    52    54    59    62    67    69    70    74    76    82    84 , ...
%     85    86    89    91    97    99   105   106   112   114   120   121   127   129   135   136   140   141   142   144   150   152 , ...
%    156   157   159   165   167   172   174   179   182   194   198   200   209   214   215   223   228   229   230   237 ...
%    34    41    42    43    48    56    57    62    71    73    77    82    84    89    91    97    99   100   104   106   112   114 , ...
   %116   120   121   125   127   129   135   137   141   142   144   150   152   157   159   164   168   170   179   184   185   193 , ...
   %198   199   200   207 ...
   % 35    38    39    40    49    53    54    63    68    70    78    86    92   101   107   117   122   132   138   147   153   161, ...
  % 169   171   176   185   186   190   199   200   201   204  ...
  %	   ];
f = [...
  ...
  position = 9;
  separator = 'On';
  hMenus = [ hWindowLevelMenu, hPanZoomMenu, hROIToolMenu, hViewImageMenu, hPointToolMenu];
...
if ~isempty(hToolbar)
	...
	old_ToolHandles  =     [Rot3D, ZoomO, ZoomI,WL,PZ,RT,MV,PM];
	old_ToolEnables  = get([Rot3D, ZoomO, ZoomI,WL,PZ,RT,MV,PM], 'Enable');
	old_ToolStates   = get([Rot3D, ZoomO, ZoomI,WL,PZ,RT,MV,PM], 'State');
...
% open new figure
fig2 = openfig('RT_tool_figure','reuse');
