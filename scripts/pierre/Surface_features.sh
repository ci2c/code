...
then
	echo ""
	echo "Usage: Surface_features.sh -sd <SUBJECTS_DIR>  -subj <SUBJ_ID>  -fwhm <FWHM>  [-comp]"
	echo ""
	...
	echo ""
	echo "Usage: Surface_features.sh -sd <SUBJCETS_DIR> -subj <SUBJ_ID>  -fwhm <FWHM>  [-comp]"
	echo ""
	exit 1
fi
...
then
	...
	if [ ! -f ${DIR}/epilepsy/registerflairT1.touch ]
	then
...
EOF
		...
		touch ${DIR}/epilepsy/registerflairT1.touch
	...
	rm -f ${DIR}/epilepsy/flair_nuc.mnc
	
	nii2mnc ${DIR}/epilepsy/flair_nuc.nii ${DIR}/epilepsy/flair_nuc.mnc
	
	mincreshape ${DIR}/epilepsy/flair_nuc.mnc ${DIR}/epilepsy/flair_nuc_byte.mnc -byte
	
	echo "mincblur -fwhm 2 ${DIR}/epilepsy/flair_nuc_byte.mnc ${DIR}/epilepsy/flair_nuc_2 -gradient -clobber"
	mincblur -fwhm 2 ${DIR}/epilepsy/flair_nuc_byte.mnc ${DIR}/epilepsy/flair_nuc_2 -gradient -clobber
	...
	rm -f ${DIR}/surf/lh.flair_nuc.dxyz.w ${DIR}/surf/rh.flair_nuc.dxyz.w ${DIR}/surf/lh.fwhm${FWHM}.flair_nuc.dxyz.w ${DIR}/surf/rh.fwhm${FWHM}.flair_nuc.dxyz.w
...
EOF
	...
	rm -f ${DIR}/surf/lh.flair_nuc.intensity.w ${DIR}/surf/rh.flair_nuc.intensity.w ${DIR}/surf/lh.fwhm${FWHM}.flair_nuc.intensity.w ${DIR}/surf/rh.fwhm${FWHM}.flair_nuc.intensity.w
...
then
	...
	if [ ! -e ${DIR}/epilepsy/pve/t1_MGRousset.img ]
	then
		mri_convert ${DIR}/mri/orig.mgz ${DIR}/epilepsy/T1_las.nii --out_orientation LAS
		...
		run_pve('${DIR}/epilepsy/T1_las.nii','${DIR}/epilepsy/pet_las.nii','${DIR}/epilepsy/pve') % original command
		% run_pve('${DIR}/epilepsy/T1_las.nii','${DIR}/epilepsy/pet_las.nii','${DIR}/epilepsy/pve', '${HOME}/SVN/matlab/pierre/pve/config_pvec', '${DIR}', [7 8 46 47] );
	
EOF
	rm -f ${DIR}/epilepsy/T1_las.nii
	fi
	...
	echo "mincblur -fwhm 2 ${DIR}/epilepsy/pve/t1_MGRousset.mnc ${DIR}/epilepsy/pve/t1_MGRousset_2 -clobber"
	mincblur -fwhm 2 ${DIR}/epilepsy/pve/t1_MGRousset.mnc ${DIR}/epilepsy/pve/t1_MGRousset_2 -clobber
...
EOF
	...
	echo "mri_vol2surf --mov ${DIR}/epilepsy/pve/t1_MGRousset_2_blur.mgz --hemi lh --surf mid --o lh.pet.w --regheader ${SUBJ} --out_type paint"
	mri_vol2surf --mov ${DIR}/epilepsy/pve/t1_MGRousset_2_blur.mgz --hemi lh --surf mid --o lh.pet.w --regheader ${SUBJ} --out_type paint

	echo "mri_vol2surf --mov ${DIR}/epilepsy/pve/t1_MGRousset_2_blur.mgz --hemi lh --surf mid --o lh.fwhm${FWHM}.pet.w --regheader ${SUBJ} --out_type paint --surf-fwhm ${FWHM}"
	...
	echo "mri_vol2surf --mov ${DIR}/epilepsy/pve/t1_MGRousset_2_blur.mgz --hemi rh --surf mid --o rh.pet.w --regheader ${SUBJ} --out_type paint"
	mri_vol2surf --mov ${DIR}/epilepsy/pve/t1_MGRousset_2_blur.mgz --hemi rh --surf mid --o rh.pet.w --regheader ${SUBJ} --out_type paint

	echo "mri_vol2surf --mov ${DIR}/epilepsy/pve/t1_MGRousset_2_blur.mgz --hemi rh --surf mid --o rh.fwhm${FWHM}.pet.w --regheader ${SUBJ} --out_type paint --surf-fwhm ${FWHM}"
	...
	echo "mris_w_to_curv ${SUBJ} lh ${DIR}/surf/lh.pet.w lh.pet"
	mris_w_to_curv ${SUBJ} lh ${DIR}/surf/lh.pet.w lh.pet

	echo "mris_w_to_curv ${SUBJ} rh ${DIR}/surf/rh.pet.w rh.pet"
	mris_w_to_curv ${SUBJ} rh ${DIR}/surf/rh.pet.w rh.pet

	echo "mris_w_to_curv ${SUBJ} lh ${DIR}/surf/lh.fwhm${FWHM}.pet.w lh.fwhm${FWHM}.pet"
	mris_w_to_curv ${SUBJ} lh ${DIR}/surf/lh.fwhm${FWHM}.pet.w lh.fwhm${FWHM}.pet

	echo "mris_w_to_curv ${SUBJ} rh ${DIR}/surf/rh.fwhm${FWHM}.pet.w rh.fwhm${FWHM}.pet"
