...
then
	echo ""
	echo "Usage:  T_create_glm_file.sh -i <input_dir> -o <output_dir> -pref1 <prefix1> -val1 <value1> -val2 <value2> [-pref2 <prefix2> -cov <covariables file>]"
	echo ""
	echo "  -i				: input dir"
	echo "  -o				: output dir"
	...
	echo ""
	echo "Usage:  T_create_glm_file.sh -i <input_dir> -o <output_dir> -pref1 <prefix1> -val1 <value1> -val2 <value2> [-pref2 <prefix2>]"
	echo ""
	echo ""
	exit 1
fi
...
* ) echo "$valuegroup2 1 $SD/$filename";;
esac
done
...
case "$filepre" in
$pregroup1 ) echo "$valuegroup1 1 $SD/$filename";;
...
T_Complete_glm_file('$glm_file','$cov')
