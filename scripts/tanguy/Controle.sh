...
then
		echo ""
		echo "Usage: Controle.sh -rp <REP> -hide <hide1> <hide2> ... <hide>"
		echo ""
		echo "  -rp                              : directory containing the patient records to control"
		echo ""
		echo "  -hide                            : files or directory to hide"
		echo ""
		echo "Usage: Controle.sh -rp <REP> -hide <hide1> <hide2> ... <hide>"
		echo ""
