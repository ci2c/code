...
then
	echo ""
	echo "Usage: DTI_FA_ictus_correc_correc.sh -sd <Subject DIR> -subj <Subject> "
	echo ""
	echo "	-sd 					: Subject directory"
	echo ""
	echo "	-subj 					: Subject"
	echo "Usage: DTI_FA_ictus_correc.sh -sd <Subject DIR> -subj <Subject> "
	echo ""
	exit 1
	exit 1
fi
...
bvec_ref='/home/tanguy/dumbo/protocoles/ictus/TBSS/TEMOINS/T1/20110222_101141IM06eaDirIM973SynoResourcee20110222101T1s008a1001.bvec'
...
bet ${DIR}/${output}/data_corr ${DIR}/${output}/data_corr_brain -F -f 0.2 -g 0 -m
