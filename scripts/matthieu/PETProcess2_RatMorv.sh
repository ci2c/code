...
then
	echo ""
	echo "Usage: PETProcess2_RatMorv.sh -id <inputsubjdir> -od <outputsubjdir> -t <templatepath>"
	echo ""
...
EOF
		...
		echo "Le fichier TemplateRat.nii est vide" >> ${OUTSUBJ_DIR}/../../LogMorvane
	fi
else
	echo "Le fichier ${OUTSUBJ_DIR}/TEP/BrainRatMaskCustom.nii n'existe pas ou est vide" >> ${OUTSUBJ_DIR}/../../LogMorvane
fi