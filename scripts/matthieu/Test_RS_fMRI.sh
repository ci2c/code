...
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	elseif strcmp('${ifacquis}','interleaved')
		sliceorder = [];
...
#     mv ${DIR}/${outdir}/run01/arepi_sm${fwhmvol}_al_MNI152_2mm.nii.gz ${DIR}/${outdir}/run01/warepi_sm${fwhmvol}_al.nii.gz

fi

# Rename Normalization files with SPM12 before applying Old Normalization
mv ${DIR}/${outdir}/run01/warepi_al.nii.gz ${DIR}/${outdir}/run01/warepi_al_Norm12.nii.gz
mv ${DIR}/${outdir}/run01/warepi_sm6_al.nii.gz ${DIR}/${outdir}/run01/warepi_sm6_al_Norm12.nii.gz
mv ${DIR}/${outdir}/run01/wmean_arepi_al.nii.gz ${DIR}/${outdir}/run01/wmean_arepi_al_Norm12.nii.gz

# Unzip files before Old Normalization
gunzip ${DIR}/${outdir}/T1_las.nii.gz ${DIR}/${outdir}/run01/mean_arepi_al.nii.gz ${DIR}/${outdir}/run01/mean_arepi.nii.gz ${DIR}/${outdir}/run01/arepi_al.nii.gz
...
# # 	fslmaths ${DIR}/${outdir}/run01/warepi_al.nii -kernel gauss ${Sigma} -fmean ${DIR}/${outdir}/run01/warepi_sm${fwhmvol}_al.nii.gz
	...
	echo "Smoothing ${DIR}/${outdir}/run01/warepi_al.nii"
	gunzip ${DIR}/${outdir}/run01/warepi_al.nii.gz
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	[tempa,tempb,tempc] = fileparts('${DIR}/${outdir}/run01/warepi_al.nii');
	...
	matlabbatch{end}.spm.spatial.smooth.prefix = 's${fwhmvol}_';

	spm_jobman('run',matlabbatch);
EOF
	mv ${DIR}/${outdir}/run01/s${fwhmvol}_warepi_al.nii ${DIR}/${outdir}/run01/warepi_sm${fwhmvol}_al.nii
	gzip ${DIR}/${outdir}/run01/warepi_sm${fwhmvol}_al.nii
...
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	[tempa,tempb,tempc] = fileparts('${DIR}/${outdir}/run01/carepi.nii');
	...
	spm_jobman('run',matlabbatch);
EOF
	mv ${DIR}/${outdir}/run01/s${fwhmvol}_carepi.nii ${DIR}/${outdir}/run01/carepi_sm${fwhmvol}.nii
	gzip ${DIR}/${outdir}/run01/carepi_sm${fwhmvol}.nii
...
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	[tempa,tempb,tempc] = fileparts('${DIR}/${outdir}/run01/carepi_sc.nii');
	...
	spm_jobman('run',matlabbatch);
EOF
	mv ${DIR}/${outdir}/run01/s${fwhmvol}_carepi_sc.nii ${DIR}/${outdir}/run01/carepi_sc_sm${fwhmvol}.nii
	gzip ${DIR}/${outdir}/run01/carepi_sc_sm${fwhmvol}.nii
...
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	[tempa,tempb,tempc] = fileparts('${DIR}/${outdir}/run01/fcarepi.nii');
	...
	spm_jobman('run',matlabbatch);
EOF
	mv ${DIR}/${outdir}/run01/s${fwhmvol}_fcarepi.nii ${DIR}/${outdir}/run01/fcarepi_sm${fwhmvol}.nii
	gzip ${DIR}/${outdir}/run01/fcarepi_sm${fwhmvol}.nii
...
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	[tempa,tempb,tempc] = fileparts('${DIR}/${outdir}/run01/fcarepi_sc.nii');
	...
	spm_jobman('run',matlabbatch);
EOF
	mv ${DIR}/${outdir}/run01/s${fwhmvol}_fcarepi_sc.nii ${DIR}/${outdir}/run01/fcarepi_sc_sm${fwhmvol}.nii
	gzip ${DIR}/${outdir}/run01/fcarepi_sc_sm${fwhmvol}.nii
