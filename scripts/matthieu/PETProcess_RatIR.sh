...
then
	echo ""
	echo "Usage: PETProcess_RatIR.sh -id <inputsubjdir> -od <outputsubjdir> -sm <smallmaskpath> -lm <largemaskpath>"
	echo ""
...
# if [[ ${OUTSUBJ_DIR} == *_IR/24H ]] || [[ ${OUTSUBJ_DIR} == *_IR/7J ]] || [[ ${OUTSUBJ_DIR} == *_IR/1M ]]
# then 
# 	if [ -e ${SM_PATH}/SBrainRatMask.nii -a -s ${SM_PATH}/SBrainRatMask.nii ]
# 	then
# 		cp ${SM_PATH}/SBrainRatMask.nii ${OUTSUBJ_DIR}/TEP
# 	else
# 		echo "Le fichier SBrainRatMask.nii n'existe pas ou est vide" >> ${OUTPUT_DIR}/../../LogRats
# 	fi
# else
...
# 		else
# 			echo "Le fichier LBrainRatMask_LAS.nii n'existe pas ou est vide" >> ${OUTPUT_DIR}/../../LogRats
# 		fi
#       elif [ ${OrientRPS} = 1 ]
#       then
...
# 		else
# 			echo "Le fichier LBrainRatMask_RPS.nii n'existe pas ou est vide" >> ${OUTPUT_DIR}/../../LogRats
# 		fi
#       fi
# fi