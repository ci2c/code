...
then
	echo ""
	echo "Usage: FMRI_PreprocessingBySPM8.sh  -sd <path>  -epi <file>  -anat <file>  -tr <value>  -rem <value> "
	echo ""
...
/usr/local/matlab11/bin/matlab -nodisplay <<EOF
	...
	%FMRI_PreprocessingBySPM8('${indir}/spm','epi_','${anat}');
	FMRI_PreprocessingBySPM8('${indir}/spm','epi_','${anat}',${TR},${N},1,1.5,6,'epi2anat','interleaved');
