...
then
	echo ""
	echo "Usage: CODE2_ActivationSubjectLevelAnalysis.sh -r1 <run1_path>  -r2 <run2_path>  -m1 <mot1_path>  -m2 <mot2_path>  -o <path>  -marker <path>  [-rmframe <value>  -tr <value> ]"
	echo ""
...
/usr/local/matlab/bin/matlab -nodisplay <<EOF
	...
	${TR}
	${remframe}
	CODE2_ActivationSubjectLevelAnalysis(epiFiles,motionFiles,'${outdir}','${marker}',${TR},${remframe});
