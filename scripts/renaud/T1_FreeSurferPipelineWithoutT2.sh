...
# Highres white stuff
log_Msg "High resolution white matter"
T1_FreeSurferHiresWhiteWithoutT2.sh "$SubjectID" "$SubjectDIR" "$T1wImage"
...
T1_FreeSurferHiresPialWithoutT2.sh "$SubjectID" "$SubjectDIR" "$T1wImage"
