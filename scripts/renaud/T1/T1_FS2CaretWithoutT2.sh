...
then
	echo ""
	echo "Usage: T1_FS2CaretWithoutT2.sh  -sd <subjects_dir>  -subj <subject>  -t1 <t1_image>  [-transf <name>  -invtransf <name>  -brainmask <name>  -atlast1 <name>  ]  "
	echo ""
...
echo ""
echo "START: T1_FS2CaretWithoutT2.sh"
echo ""
...
echo ""
echo "END: T1_FS2CaretWithoutT2.sh"
