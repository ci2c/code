...
mv ${Dicom}/pcasl_8/* ${Dicom}_8c/pcasl_8/
...
#tem=`basename $Dicom`
#recon-all -all -subjid $tem -sd /home/sebastien/NAS/sebastien/Master_seb/ -nuintensitycor-3T && recon-all -all -subjid ${tem}_8c -sd /home/sebastien/NAS/sebastien/Master_seb/ -nuintensitycor-3T
