function aslmapseb(Mz,deltaM0,outname,mask)
...
% 
% end
% V1=spm_vol('/home/fatmike/sebastien/comaj/460502AM031211/asl/process/Vol_1_mean.nii');
% V2=spm_vol('/home/fatmike/sebastien/comaj/460502AM031211/asl/process/diff_map.nii');
V1=spm_vol(Mz);
V2=spm_vol(deltaM0);
V3=spm_vol(mask);
...
CBFtemp=(6000*data2.*exp(1.525+(0.035.*(C-1))./1.68))./(2.*0.85.*1.68.*data1);
CBF=CBFtemp.*data3;
