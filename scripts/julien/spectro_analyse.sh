...
sed -i -e "s/ci2c - //g" ${output}/${subject}_lcm_file/${subject}_${input_base}.ps
sed -i -e "s/INSERM unit 837, \"Development and plasticity of the postnatal brain,\"/Clinical Imaging Core faCility - ci2c - /g" ${output}/${subject}_lcm_file/${subject}_${input_base}.ps
