...
if [ "${dcm}" != "./" ]
then
info_dicom=$(dcmdump -M +P "0020,0011" +P "0008,0020" +P "0010,0010" +P "0008,1030" +P "0008,103e" +P "0008,0030" +P "0008,0020" +P "0008,0050" +P "0010,0030" +P "0010,0040" +P "0008,0031" ${dcm} | sed -e 's/.*\[\(.*\)\].*/\1/')
...
"
mkdir -p ${input}/${current_serie_number}_${current_serie_description}
mv ${dcm} ${input}/${current_serie_number}_${current_serie_description}
