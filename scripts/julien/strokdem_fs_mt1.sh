...
recon-all -all -sd /tmp -s ${subject}_${ses} -i /home/fatmike/Protocoles_3T/Strokdem/data/${subject}/${ses}/mt1.nii -nuintensitycor-3T -hippo-subfields
cp -Rf /tmp/${subject}_${ses}  /home/fatmike/Protocoles_3T/Strokdem/FS5.1
