...
#RV essai 1 : J'ai ajouté -no-fix-with-ga -fix-diag-only parceque source de blocage et prend beaucoup de temps et de mémoire....
#RV essai 2 : J'ai ajouté -nofix parceque source de blocage et prend beaucoup de temps et de mémoire....et ca ne fonctionne pas avec -no-fix-with-ga -fix-diag-only
cmd="recon-all  -autorecon2-wm -autorecon3 -subjid $Subject -sd $StudyFolder -nuintensitycor-3T -nofix"
echo $cmd ; eval $cmd
