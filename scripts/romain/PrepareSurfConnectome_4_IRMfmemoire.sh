...
then
	echo ""
	echo "Usage: PrepareSurfaceConnectome.sh  -fs  <SubjDir>  -subj  <SubjName>  [-lmax <lmax>  -N <Nfiber>  -no-shift -las]"
	echo ""
	...
	echo "  -las	                     : Change for a las orientation intead of a ras orientation"
	echo " "
...
echo
echo "#############################"
echo "# Step 1. Correct distortions"
echo "#############################"
echo
...
echo
echo "#############################"
echo "# Step 4. Apply distortion corrections to the whole DWI"
echo "#############################"
echo
...
then
	...
	rm -f ${DCDIR}/*ucorr_jac.n/ii.gz ${DCDIR}/voltmp*
	gzip -f ${DCDIR}/*.nii	
fi

echo
echo "#############################"
echo "## Step 5. Compute DTI fit on fully corrected DTI"
echo "#############################"
echo
...
echo
echo "#############################"
echo "# Step 6. Get freesurfer WM mask"
echo "#############################"
echo 
...
#RV ajout des structures 7 46 16 28 pour relier le masque white matter et le cervelet 
	mri_extract_label ${DIR}/mri/aparc.a2009s+aseg.mgz 10 11 12 13 17 18 26 49 50 51 52 53 54 58 7 46 16 28 ${DTI}/sc_labels_tmp.mgz
	...
	then
		...
		echo "mri_convert ${DTI}/white_dil.mgz ${DTI}/wm_mask.nii --out_orientation LAS"
		mri_convert ${DTI}/white_dil.mgz ${DTI}/wm_mask.nii --out_orientation LAS
	fi	
...
echo
echo "#############################"
echo "# Step 7. Register T1 to DTI"
echo "#############################"
echo
...
then
	...
	then
		...
		echo "mri_convert ${DIR}/mri/nu.mgz ${DTI}/t1_native_ras.nii --out_orientation LAS"
		mri_convert ${DIR}/mri/nu.mgz ${DTI}/t1_native_ras.nii --out_orientation LAS
	fi	
...
echo
echo "#############################"
echo "# Step 8. Performs tractography"
echo "#############################"
echo

	echo
	echo "#############################"
	echo "# Step 8.1 Convert images and bvec"
	echo "#############################"
	echo
...
EOF
	...
	echo
	echo "#############################"
	echo "# Step 8.2 All steps until the response estimate"
	echo "#############################"
	echo
...
then
	...
	echo
	echo "#############################"
	echo "# Step 8.3 Spherical deconvolution"
	echo "#############################"
	echo
...
then
	...
	Nfile=`echo "scale=0; ${Nfiber} / ${NfiberPerFile}" | bc -l`
	Ifile=1
	...
	echo
	echo "#############################"
	echo "#Step 8.5 Merge the fiber files into unique a tck file"
	echo "#############################"
	echo
if [ ! -e ${DTI}/whole_brain_${lmax}_${Nfiber}.tck ]
 then
echo "cat_fibers(${Nfiber},${NfiberPerFile},'${DTI}','whole_brain_${lmax}_${Nfiber}');"
matlab -nodisplay <<EOF
cat_fibers(${Nfiber},${NfiberPerFile},'${DTI}','whole_brain_${lmax}_${Nfiber}');
EOF
fi

echo
echo "#############################"
echo "# Step 9. Save cortical surfaces in volume space"
echo "#############################"
echo
...
then
	...
	mri_convert ${DIR}/mri/T1.mgz ${DIR}/mri/t1_ras.nii --out_orientation LAS
fi
