...
export HCPPIPEDIR="/home/romain/SVN/scripts/romain"
...
#./DiffPreprocPipeline.sh --path=/NAS/tupac/romain/testHRSFC/ --subject=comblez --PEdir=2 --posData=/NAS/tupac/romain/testHRSFC/comblez/dti/dti.nii.gz --negData=/NAS/tupac/romain/testHRSFC/comblez/dti/dti_back.nii.gz --echospacing=0.7 --gdcoeffs=NONE 
...
echo get_options $@
	get_options $@
echo validate_environment_vars $@
	# Validate environment variables
	validate_environment_vars $@
echo log_SetToolName "DiffPreprocPipeline.sh"
